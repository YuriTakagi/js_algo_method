...
こうした書き方の差異は、チーム開発など複数人でプログラムを作成する場合に、次のような問題につながることがあります。

書き方が統一されないことで、コードが読みにくくなる。

本質的なロジックの部分に集中できず、バグが発生しやすくなったり、メンテナンスが大変になったりする。
...
問題文
(1)
次の選択肢のうち、コーディング規則の例として最も適切でないものを 1 つ選んでください。ただし、1. から 3. のすべてが適切である場合、4. を選んでください。
...
(2)
次の選択肢のうち、コーディング規則に対する態度として最も適切でないものを 1 つ選んでください。
